...
export class SearchUser extends Component {
    ...
    submitFollowers = () => {
        ...
        this.props.followersFetchData(`https://api.github.com/users/${userInput}/followers`)
        setTimeout(this.setState({showFollowers: !this.state.showFollowers}),500)
    }
    render() {
        ...
        return (
            ...
            <div className="App">
                ...
                {this.state.showUser ? 
                <User
                submitFollowers={() => this.submitFollowers()}
                /> :
                null
                }
